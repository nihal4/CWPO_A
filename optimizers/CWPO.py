...
def CWPO(objf, lb, ub, dim, SearchAgents_no, Max_iter, alpha=0.6, beta=0.3, omega_freq=0.25, sf=1.5, levy_lambda=1.4, p=-.95):
    #alpha=1.5, beta=0.5, omega_freq=0.1, sf=5.0, levy_lambda=1.5, p=-1
    """
    Cat Water Phobia Optimizer (CWPO)
